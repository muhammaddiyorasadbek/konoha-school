...
export default function Login({ onBack }: Props) {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    // Kichkina kechikish — yanada haqiqiyroq tuyiladi
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4 bg-gradient-to-br from-sakura-50 via-white to-sakura-100">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-jp text-[40vw] font-black text-sakura-100/30 leading-none select-none">
          学
        </div>
      </div>
      ...
      <div className="relative w-full max-w-md fade-up">
        ...
        <button
          onClick={onBack}
          className="mb-4 inline-flex items-center gap-2 text-sm text-gray-600 hover:text-konoha-red transition-colors"
        >
          ← Saytga qaytish
        </button>
        ...
        <div className="bg-white rounded-[32px] shadow-2xl shadow-sakura-300/40 border border-sakura-100 overflow-hidden">
          ...
          <div className="relative bg-gradient-to-br from-konoha-red via-sakura-600 to-sakura-700 p-7 text-white text-center overflow-hidden">
            <div className="absolute -top-4 -right-4 font-jp text-[120px] font-black text-white/10 leading-none">
              学
            </div>
            <div className="absolute -bottom-8 -left-4 font-jp text-[100px] font-black text-white/10 leading-none">
              校
            </div>
          ...
          <form onSubmit={submit} className="p-7 space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl bg-white border-2 border-sakura-100 focus:border-konoha-red focus:outline-none focus:ring-4 focus:ring-sakura-100 transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-12 py-3 rounded-xl bg-white border-2 border-sakura-100 focus:border-konoha-red focus:outline-none focus:ring-4 focus:ring-sakura-100 transition-all"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((v) => !v)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-konoha-red transition-colors"
                  tabIndex={-1}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl bg-gradient-to-r from-konoha-red to-sakura-600 text-white font-bold shadow-lg shadow-sakura-400/40 hover:-translate-y-0.5 hover:shadow-xl active:scale-95 transition-all shine-effect overflow-hidden disabled:opacity-70 disabled:pointer-events-none"
            >
              {loading ? (
